clear
close all
cd /Volumes/ACO_RAP_2/RAP/Oct2018Cruise/wav_data/icListen/28_Oct
% cd /Users/testuser/Desktop/Harbor_Test/Data/icListen
fname = 'SBW1391_20181028_151000.wav'
...
w = hann(length(yf));
[pxx,f] = periodogram(yf.*w,[],nfft,32000);
f(2)-f(1)
%% 
figure(1)
plot(f,pxx)
