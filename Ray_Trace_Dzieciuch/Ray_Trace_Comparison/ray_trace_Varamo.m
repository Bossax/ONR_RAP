function [ arc_lengths,tot_dist,theta0,SS_no_curv,z_no_curv,SS_HOT_avg,surface_dist,est_tt,ray_angles ] = ray_trace_Varamo( x_dist,z_offset )
...
%Apriori SS field
SS_no_curv=gsw_sound_speed(sal,temp,pres);

z_no_curv=-gsw_z_from_p(pres,22.738894);

%Correct for Earth Curvature
E_radius=6371000;
E=z_no_curv./E_radius;
z=z_no_curv.*(1+(E./2)+((E.^2)./3));
%z(end)=hyd_depth;
SS=SS_no_curv.*(1+E+E.^2);
