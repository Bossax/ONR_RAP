...
while true
    cd("/Volumes/ACO_RAP_2/RAP/June2018Cruise/wav_data/HEM/" + string(now_day)+"_June")
    if now_day < 10
    ...
    if now_hour < 10
        fname_d = "1806"+str_now_day+"-0"+string(now_hour);
    else
        fname_d = "1806"+str_now_day+"-"+string(now_hour);
    end
    d = dir(fname_d+"*");
...
while true
    ...
    while true
        ...
        audio_hour = str2double(mat_name(8:9));
        if audio_hour == now_hour
            % Timing audio data
...
if now_day == 7 & now_hour == 2
    ...
    for p = 1:2
        if p ==1 & now_hour == 0
            ...
            fname_d = "tx_data_2018_06_"+str_now_day+"_"+string(23);
        ...
        elseif p==1 & now_hour == 10
            ...
            fname_d = "tx_data_2018_06_"+str_now_day+"_0"+string(9);
        ...
        elseif now_hour < 10
            ...
            fname_d = "tx_data_2018_06_"+str_now_day+"_0"+string(now_hour-2+p);
            ...
            fname_d = "tx_data_2018_06_"+str_now_day+"_"+string(now_hour-2+p);
