...
clearvars
close all
bin_file_dir = '/Volumes/ACO_RAP_2/RAP/June2017Cruise/POS-MV';
save_file_dir = '/Volumes/ACO_RAP_2/RAP/June2017Cruise/Tx_Rx_Output/posmv';
cd(bin_file_dir)
directory=dir('km1706*');

for jj = 97:length(directory)
fname = directory(jj).name;
...
t=datenum(2017,6,sunday)+t1./(3600*24);
t_err=datenum(2017,6,sunday)+t1_1./(3600*24);
...
save_fname = "posmv_201706"+day+hour;
fprintf(save_fname +"\n.\n.\n")
